...
public class Main {
	...
	public static void main(String[] args) {
		...
		comms[12] = new SMS("00446999888888", "00478484777777", 15, 10, 2022, "Metro Attack ready");
		...
		// Creation of panel for suspect search
		SuspectSearchFrame sf = new SuspectSearchFrame(registry);
	}
